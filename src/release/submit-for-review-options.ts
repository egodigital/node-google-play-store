...
import {EditsDetailsInterface} from "../edits";
import {TrackId} from "./track-id";
import {LocalizedListingInterface} from "./localized-listing.interface";

export interface SubmitForReviewOptions {
    editId?: string;
    autoAttachVersionCode?: number;
    releaseNotes?: string | ReleaseNotesInterface | ReleaseNotesInterface[];
    details?: EditsDetailsInterface;
    track?: TrackId
    listings?: LocalizedListingInterface[];
}